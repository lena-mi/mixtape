<script lang="ts">
  type TrackState = 'idle' | 'processing' | 'filled' | 'renaming' | 'error'
...
<div class="track-wrap">
  <div class="track-row">
    <div
      ...
      class:is-processing={trackState === 'processing'}
    >
      ...
      {:else if trackState === 'processing'}
        <div class="processing-fill" aria-label="Processing…" aria-busy="true"></div>
  ...
  {#if trackState === 'error'}
    <p class="error-hint">Paste a YouTube link — youtube.com/watch?v=… or youtu.be/…</p>
  {/if}
</div>
...
<style>
  ...
  /* ── Idle: input fills remaining space, no own border ── */
  ...
  /* ── Processing: shimmer fills remaining space ── */
  ...
  /* ── Filled: Caveat display + external action buttons ── */
  ...
  /* ── Renaming: input box with inline confirm button ── */
